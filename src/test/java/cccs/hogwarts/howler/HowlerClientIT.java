...
import cccs.hogwarts.howler.models.GroupedModel;
import cccs.hogwarts.howler.models.HitValidationModel;
import cccs.hogwarts.howler.models.generated.HitModel;
import cccs.hogwarts.howler.models.generated.HowlerModel;
...
public class HowlerClientIT {
    ...
    @Before
    public void init() {
        if (!Strings.isNullOrEmpty(System.getenv("VAULT_REFRESH_TOKEN"))) {
            System.out.println("Using OBO Authentication");
            howlerClient.initializeOboAuthentication();
        } else {
